 ...
 */
abstract public class EditMeasurments extends EditTextPreference {
    boolean mIsMetric;
    ...
    public EditMeasurments(Context context) {
        super(context);
        initPreferenceDetails();
    }

    public EditMeasurments(Context context, AttributeSet attr) {
        super(context, attr);
        initPreferenceDetails();
    }

    public EditMeasurments(Context context, AttributeSet attr, int defStyle) {
